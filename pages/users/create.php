...
<head>
  ...
  <title>Novo Usuário — TV Doutor CRM</title>
...
<main class="flex-1 p-4 lg:p-8 overflow-auto pt-16 lg:pt-4">
  <div class="max-w-lg mx-auto">
    ...
    <h1 class="text-2xl font-bold text-gray-800 mt-4 mb-6">Novo Usuário</h1>
    ...
    <form method="POST" class="bg-white rounded-xl border border-gray-100 shadow-sm p-6 space-y-4">
      ...
      <div class="flex gap-3 pt-2">
        <button type="submit" class="bg-brand text-white px-6 py-2.5 rounded-lg text-sm font-semibold hover:bg-blue-800 transition">Criar Usuário</button>
